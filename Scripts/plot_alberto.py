...
for i in range(-2,3):
    ...
    label = 'Replicate '+str(i+3), linewidth=0.5, width=ancho)
...
axes.legend(loc='best', fontsize = size_legend)
axes.set_ylabel('Peak height (mV)', fontsize = size_label)
axes.set_xlabel('Peak number', fontsize = size_label)
